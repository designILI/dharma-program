...
for(let grade=1;grade<=8;grade++){
  ...
  const unitTitleMap={
    ...
    8:{1:'The Nature of Mind',2:'Milarepa: From Darkness to Light',3:'The Stupa & the Whole Curriculum',4:'The Girl Who Became a Buddha — Pajapati Novel Study',5:'Yangku, Advanced Practice & the Threshold'}
  };
