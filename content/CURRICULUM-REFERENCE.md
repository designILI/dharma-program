# Dharma Program — Curriculum Reference
*All 152 lessons · All 13 prayers · All anchor texts · Buddhist / Universal classification*

---

## How to Read the Classification

Each lesson in Part 3 is tagged:
...
| Grade | New Prayers | Cumulative Total |
|-------|------------|-----------------|
| 1 | Kyap Dro · Om Mani Padme Hung · Manjushri Prayer | 3 |
| 2 | + Sem kye · Ngowa | 5 |
| 3 | + Seven-Line Guru Rinpoche Prayer · Food Offering Prayer | 7 |
| 4 | + Sevenline extended form · Dusum Sangay | 9 |
| 5 | + Dechen Monlam | 10 |
...
Primary texts, stories, images, and objects that anchor specific units. Listed in order of first appearance.
...
## Part 3 — Master Lesson Index

All 152 lessons, in sequence. Columns: **ID · Title · Core Concept · Bloom's Band · B/U Tag**

**Bloom's Bands by Grade:**
- Grades 1–3: Remember / Understand / Apply (R/U/A)
- Grades 4–5: Understand / Apply / Analyze (U/A/An)
- Grade 6: Analyze (An)
- Grades 7–8: Evaluate / Create (E/C)

---

### Grade 1 — The Circle of Kindness
*27 lessons · Ages 6–7*

#### Unit 1 — Om Mani Padme Hung & Prayer Flags

| ID | Title | Core Concept | Bloom's | Tag |
|----|-------|-------------|---------|-----|
| G1.U1.C1 | The Sound of Kindness | Sound as carrier of compassion; the mantra as vibration | R | B |
| G1.U1.C2 | Six Little Syllables | The six syllables of Om Mani Padme Hung and their meaning | R/U | B |
| G1.U1.C3 | Flags in the Wind | Prayer flags as carriers of intention; wind as transmitter | U | B+U |
| G1.U1.C4 | Painting Our Wishes | Making as a form of intention-setting; wishes made visible | A | B+U |
| G1.U1.C5 | Finishing & Sharing | Completion and community; the meaning of sharing a made object | A | U |
| G1.U1.C6 | Hoisting Day | Ritual as marker of intention sent into the world | A | B |

#### Unit 2 — The Giving Tree / Unconditional Love

| ID | Title | Core Concept | Bloom's | Tag |
|----|-------|-------------|---------|-----|
| G1.U2.C1 | A Tree Who Loved a Boy | Unconditional love; giving without expectation | R/U | U |
| G1.U2.C2 | Giving and Getting | The difference between transactional and unconditional generosity | U | U |
| G1.U2.C3 | Making the Crown | Gratitude expressed through making | A | U |
| G1.U2.C4 | The Gratitude Circle | Gratitude as community practice; the circle as form | A | B+U |

#### Unit 3 — Guru Rinpoche's Birth

| ID | Title | Core Concept | Bloom's | Tag |
|----|-------|-------------|---------|-----|
| G1.U3.C1 | Born on a Lotus | The miraculous birth; sacred origin stories | R | B |
| G1.U3.C2 | The Precious Teacher | The teacher as guide; the lineage of wisdom | R/U | B |
| G1.U3.C3 | Drawing the Lotus Lake | Visualisation through art; Guru Rinpoche's Lotus Lake | A | B |
| G1.U3.C4 | Our Lotus Gallery | Community sharing of visual work; art as offering | A | B+U |

#### Unit 4 — Patience & the Bugs

| ID | Title | Core Concept | Bloom's | Tag |
|----|-------|-------------|---------|-----|
| G1.U4.C1 | The Brave Little Parrot | Courage and sacrifice; the Jataka tale as moral story | R/U | B+U |
| G1.U4.C2 | Do Bugs Feel? | Sentient beings; the scope of compassion extended to insects | U | B+U |
| G1.U4.C3 | Watching Closely | Careful observation; mindfulness of the natural world | A | U |
| G1.U4.C4 | The Rescue | Compassion in action; caring for living things | A | B+U |

#### Unit 5 — Buddha's Birth

| ID | Title | Core Concept | Bloom's | Tag |
|----|-------|-------------|---------|-----|
| G1.U5.C1 | A Very Special Baby | The Buddha's miraculous birth; sacred origins | R | B |
| G1.U5.C2 | He Was Little Like Us | The Buddha's humanity; accessibility of the teaching | U | B+U |
| G1.U5.C3 | Making Our Book Pages | Illustration as understanding; storytelling through image | A | U |
| G1.U5.C4 | Reading Our Book | Sharing stories; the book as community object | A | U |

#### Unit 6 — Jataka Stories / Rotating Library
...
### Grade 2 — The Widening Circle
*16 lessons · Ages 7–8*

#### Unit 1 — Prayer Flags & Expanding Compassion

| ID | Title | Core Concept | Bloom's | Tag |
|----|-------|-------------|---------|-----|
| G2.U1.C1 | Painting Our Flags | Art as intention; expanding compassion outward in rings | U/A | B+U |
| G2.U1.C2 | Finishing the Flags | Craft completion; the satisfaction of finishing | A | U |
| G2.U1.C3 | The Inner Ring (Family) | Compassion beginning with family; the first circle | U | U |
| G2.U1.C4 | The Second Ring (Friends & Neighbours) | Extending compassion beyond immediate family | U | U |
| G2.U1.C5 | The Third Ring (Animals) | Non-human sentient beings as members of the compassion circle | U | B+U |
| G2.U1.C6 | The Widest Ring (All Beings) | Universal compassion (metta); the aspiration for all beings | U | B+U |
| G2.U1.C7 | Sharing the Circle | Community sharing; the flags hoisted as communal offering | A | U |

#### Unit 2 — The Life of the Buddha *(Pajapati seed: C1)*

| ID | Title | Core Concept | Bloom's | Tag |
|----|-------|-------------|---------|-----|
| G2.U2.C1 | The Prince in the Palace | The Buddha's early life; privilege and sheltering; **Pajapati seed planted** | R/U | B |
| G2.U2.C2 | The Four Sights | Old age, illness, death, and the renunciant — the awakening catalyst | U | B |
| G2.U2.C3 | Leaving Everything | Renunciation; the decision to seek truth over comfort | U | B+U |
| G2.U2.C4 | Under the Tree | The Buddha's enlightenment; what awakening means | U | B |
| G2.U2.C5 | Telling the Story | Narrative as transmission; retelling the whole story | A | U |

#### Unit 3 — Guru Rinpoche (Deeper)
...
### Grade 3 — Compassion in Action
*14 lessons · Ages 8–9*

#### Unit 1 — Tsethar / Life Release

| ID | Title | Core Concept | Bloom's | Tag |
|----|-------|-------------|---------|-----|
| G3.U1.C1 | The Fish King | The Jataka tale of the Fish King; compassionate leadership | U | B+U |
| G3.U1.C2 | If I Were the Fish | Perspective-taking through embodied imagination | U/A | U |
...
| ID | Title | Core Concept | Bloom's | Tag |
|----|-------|-------------|---------|-----|
| G3.U2.C1 | Kindness Is a Muscle | Compassion as a trainable capacity; habit formation | U | U |
| G3.U2.C2 | Spotting the Moment | Ethical awareness; recognising the moment to act | A | U |
| G3.U2.C3 | Our Kind Acts | Documentation of compassionate action; accountability | A | U |
| G3.U2.C4 | Sharing Our Actions | Witnessing each other's practice; community | A | U |

#### Unit 3 — Saga Dawa & Sacred Time

| ID | Title | Core Concept | Bloom's | Tag |
|----|-------|-------------|---------|-----|
| G3.U3.C1 | The Most Sacred Month | Saga Dawa; the Buddhist calendar; sacred time | U | B |
| G3.U3.C2 | Three Great Moments | Buddha's birth, enlightenment, and parinirvana in one month | U | B |
| G3.U3.C3 | Preparing Our Offerings | Ritual preparation as mindful action | A | B |
| G3.U3.C4 | Observing Together | Community ceremony; participating in a living tradition | A | B |

---

### Grade 4 — The Language of Ritual
*16 lessons · Ages 9–10*

#### Unit 1 — The Seven-Bowl Water Offering

| ID | Title | Core Concept | Bloom's | Tag |
|----|-------|-------------|---------|-----|
| G4.U1.C1 | Why We Offer | The logic of offering; generosity as practice | U | B+U |
| G4.U1.C2 | The Seven Bowls | The seven offerings and their symbolic meanings | U/A | B |
| G4.U1.C3 | The Right Way | Precision as a form of attention; ritual correctness | A | B |
| G4.U1.C4 | Practising Together | Embodied ritual practice; community precision | A | B |
| G4.U1.C5 | Our Diagram | Documentation and understanding; the diagram as synthesis | A | U |
| G4.U1.C6 | Demonstration Day | Teaching a practice to others; first near-peer transmission | A | B+U |

#### Unit 2 — Making Tormas

| ID | Title | Core Concept | Bloom's | Tag |
|----|-------|-------------|---------|-----|
| G4.U2.C1 | What Is a Torma? | The torma as offering object; symbolic meaning in form | U | B |
| G4.U2.C2 | Patience in the Making | Sustained attention; patience as a virtue embodied in craft | A | U |
| G4.U2.C3 | Shaping | Making as meditation; the hand learning what the mind knows | A | B+U |
| G4.U2.C4 | Finishing | Completion as offering; the quality brought to the last stage | A | B+U |
| G4.U2.C5 | The Offering | Ceremony; presenting what was made as a genuine gift | A | B |

#### Unit 3 — Instruments & Ritual Objects

| ID | Title | Core Concept | Bloom's | Tag |
|----|-------|-------------|---------|-----|
| G4.U3.C1 | The Sound of the Shrine | Sacred sound; the meaning of ritual instruments | U | B |
| G4.U3.C2 | Objects of Practice | Ritual object literacy; reading symbolic meaning | U/A | B |
| G4.U3.C3 | Counting with the Mala | The mala as embodied practice; mantra and repetition | A | B |
| G4.U3.C4 | Building the Field Guide | Documentation as synthesis; organising understanding | A | U |
| G4.U3.C5 | Presenting the Guide | Teaching peers; the guide as a teaching object | A | U |

---

### Grade 5 — The Wheel of Existence
*14 lessons · Ages 10–11*

#### Unit 1 — The Wheel of Life / Sipa Khorlo

| ID | Title | Core Concept | Bloom's | Tag |
|----|-------|-------------|---------|-----|
| G5.U1.C1 | A Picture That Is a Teaching | The thangka as encoded teaching; visual texts | U/A | B |
| G5.U1.C2 | The Center | The three poisons (ignorance, desire, aversion) as root of suffering | U/A | B |
| G5.U1.C3 | The Turning Rim | The six realms; the Twelve Links introduced as a label | A | B |
| G5.U1.C4 | Drawing Our Wheel | Understanding through making; art as synthesis | A | B+U |
| G5.U1.C5 | Reading Our Wheels | Three-part reflection revisited; community sharing | A | B+U |

#### Unit 2 — The Six Realms

| ID | Title | Core Concept | Bloom's | Tag |
|----|-------|-------------|---------|-----|
| G5.U2.C1 | Six Kinds of Life | The six realms as cosmology and as psychological map | U/A | B |
| G5.U2.C2 | The Hungry Ghosts | Craving and unsatisfiability; the hungry ghost realm as inner state | A | B+U |
| G5.U2.C3 | Realms Inside Us | The realms as descriptions of inner experience | A | B+U |
| G5.U2.C4 | Drawing the Realms | Visual synthesis; each realm given form | A | B+U |
| G5.U2.C5 | Sharing & Reflecting | Community reflection; the Wheel as shared map | A | U |

#### Unit 3 — Padmasambhava & the Coming of the Dharma

| ID | Title | Core Concept | Bloom's | Tag |
|----|-------|-------------|---------|-----|
| G5.U3.C1 | The Second Buddha | Padmasambhava as the one who brought the Dharma to Tibet | U/A | B |
| G5.U3.C2 | Bringing the Teachings | The transmission of the Dharma; how a teaching travels | A | B |
| G5.U3.C3 | The Chain of Teachers | Lineage as a living chain; students named at the end of it | A | B+U |
| G5.U3.C4 | Our Map | The personal lineage map; locating oneself in the tradition | A | B+U |

---

### Grade 6 — Death & What It Asks of Us
*19 lessons · Ages 11–12*

#### Unit 1 — Rebirth

| ID | Title | Core Concept | Bloom's | Tag |
|----|-------|-------------|---------|-----|
| G6.U1.C1 | Born Again? | The Buddhist teaching on rebirth; the consciousness stream | An | B |
| G6.U1.C2 | Not a Fixed Thing | Anattā (no-fixed-self); the self as process | An | B |
...
### Grade 7 — Teaching as Practice
*20 lessons · Ages 12–13*

#### Unit 1 — Bullying & Empathy
...
| G7.U1.C5 | Our Position | Personal position paper; defending with argument | E/C | U |

#### Unit 2 — The Near-Peer Teaching Project

| ID | Title | Core Concept | Bloom's | Tag |
|----|-------|-------------|---------|-----|
| G7.U2.C1 | Learning by Teaching | The Feynman Principle; understanding tested by transmission | E | U |
| G7.U2.C2 | Choosing a Topic | What makes a topic teachable; lesson design criteria | E/C | U |
| G7.U2.C3 | First Draft | Lesson plan drafting; the five-section structure | C | U |
| G7.U2.C4 | Critique & Revise | Structured peer critique; iterative design | E/C | U |
| G7.U2.C5 | Rehearsal | Full run-through; preparation vs. performance | C | U |
| G7.U2.C6 | Teaching Day | Actual near-peer teaching; the threshold of transmission | C | U |
| G7.U2.C7 | Reflection | Three-part reflection on Teaching Day; metacognition | E | U |

#### Unit 3 — Medicine Buddha

| ID | Title | Core Concept | Bloom's | Tag |
|----|-------|-------------|---------|-----|
| G7.U3.C1 | The Healer | Sangye Menla's twelve vows; healing intention as practice | E | B |
| G7.U3.C2 | More Than the Body | Three poisons as root of illness; the mantra and its meaning | E | B+U |
| G7.U3.C3 | An Aspiration for Someone | Drafting a formal healing aspiration for a specific person | C | B+U |
| G7.U3.C4 | Sharing Our Healing Wishes | Ceremonial sharing; dedication of merit after each aspiration | C | B |

#### Unit 4 — Panglhabsol / Protector Practice

| ID | Title | Core Concept | Bloom's | Tag |
|----|-------|-------------|---------|-----|
| G7.U4.C1 | What We Honour | Lineage (*brgyud pa*); the personal lineage map | E | B+U |
| G7.U4.C2 | The Smoke Offering | Rewo Sang Chod performed; smoke as carrier of offering | E | B |
| G7.U4.C3 | Preparing | Full Panglhabsol ceremony mapped; spiral connections to curriculum | E | B+U |
| G7.U4.C4 | Observing Together | Closing declaration as vow; gratitude and forward intention | E/C | B+U |

---

### Grade 8 — The Nature of Mind
*26 lessons · Ages 13–14*

#### Unit 1 — Sipa Khorlo, Philosophically
...
| G8.U1.C5 | Defending an Interpretation | Socratic discussion; dialectic; position refined under pressure | E/C | U |

#### Unit 2 — Milarepa & the Great Yogis

| ID | Title | Core Concept | Bloom's | Tag |
|----|-------|-------------|---------|-----|
| G8.U2.C1 | The Sorcerer | Milarepa's early life and mass murder; moral complexity; remorse vs. guilt | E | B+U |
| G8.U2.C2 | The Hard Teacher | Marpa-Milarepa; penance; the pedagogy of hardship | E | B+U |
| G8.U2.C3 | The Cave | Solitary retreat; qualitative transformation; the songs | E | B+U |
| G8.U2.C4 | Turning Points | Internal readiness + external catalyst; turning-point analysis | E | U |
| G8.U2.C5 | Can Anyone Change? | Culminating philosophical response; transformation and the Twelve Links | E/C | U |

#### Unit 3 — The Stupas

| ID | Title | Core Concept | Bloom's | Tag |
|----|-------|-------------|---------|-----|
| G8.U3.C1 | Mind Made of Stone | Stupa structure and meaning; circumambulation as practice | E | B |
| G8.U3.C2 | Reading a Stupa | Iconography; each element connected to the full curriculum | E | B |
| G8.U3.C3 | Building | Making a model stupa; sustained attention; teaching encoded in hands | C | B+U |
| G8.U3.C4 | Presenting the Stupa | Presenting the stupa as transmission; explaining each element | C | B+U |

#### Unit 4 — *The Girl Who Became a Buddha* / Pajapati Novel Study
*(Full Pajapati arc — students have carried her name since Grade 2)*
...
| G8.U4.C5 | He Leaves; She Remains | The walk; three refusals and three askings; Tara-Pajapati connection arrives | E | B+U |
| G8.U4.C6 | Her Own Awakening | Monastic practice; teaching; enlightenment; arahant recognition | E | B |
| G8.U4.C7 | Reclaiming the Untold | Canon and what gets excluded; final creative piece | E/C | B+U |

#### Unit 5 — Yangku, Advanced Practice & the Threshold

| ID | Title | Core Concept | Bloom's | Tag |
|----|-------|-------------|---------|-----|
| G8.U5.C1 | Completing the Repertoire | All 13 prayers mapped; the repertoire as permanently owned | E | B |
...
| Theme | Key Lessons |
|-------|------------|
| **Compassion / Empathy** | G1.U2, G2.U1, G3.U2, G7.U1 |
| **Grief & Loss** | G6.U2.C2, G8.U4.C3, G8.U4.C4 |
| **Identity & Self** | G6.U1.C2–C3, G8.U1.C3 |
...
### Buddhist Concepts That Appear in Multiple Grades (Spiral Threads)

| Concept | First Appearance | Returns |
|---------|-----------------|---------|
| Om Mani Padme Hung | G1.U1 | G7.U2.C1 (Feynman exercise); G8.U5.C1 |
| Guru Rinpoche / Padmasambhava | G1.U3 | G2.U3; G5.U3 |
| Karma / Intentional action | G1 (kindness) | G5 (Wheel's rim); G8.U1 (Twelve Links); G8.U2 |
| Impermanence | G2.U2 (Buddha leaves) | G6.U1; G6.U2; G8.U1–U2 |
| Compassion circles (metta) | G2.U1 | G7.U3 (Medicine Buddha); G8.U5.C5 |
